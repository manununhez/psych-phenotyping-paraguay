...
Este conjunto de documentos está pensado para acompañar la redacción metodológica y la preparación de manuscritos. El foco no es repetir el contenido de los notebooks, sino ordenar la lógica metodológica detrás de las decisiones técnicas.
...
11. `09_analisis_errores_hibrido`

## Mapa de documentos
- `01_preguntas_clave_estudio.md`: define qué preguntas debe responder el estudio.
...
- `compendio_llm.md`: versión consolidada para ingesta rápida en NotebookLM.

## Sugerencia práctica para NotebookLM
Primero cargar `compendio_llm.md` para dar contexto general. Después sumar, en este orden, `02`, `03`, `06` y `07` para reforzar la lógica de diseño y los trade-offs metodológicos.
